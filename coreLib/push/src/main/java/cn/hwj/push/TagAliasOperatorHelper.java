...
public class TagAliasOperatorHelper {
    ...
    public static void initJpushArg(Context context,String uniqueId) {
...
//        builder.notificationFlags = Notification.FLAG_AUTO_CANCEL;  //设置为点击后自动消失
        ...
        String tag = uniqueId;
        action = ACTION_SET;
        TagAliasBean tagAliasBean_set = new TagAliasBean();
        ...
        if (!tagSet.isEmpty()) {
            ...
            TagAliasOperatorHelper.getInstance().handleAction(context, sequence, tagAliasBean_set);
        }
    }
